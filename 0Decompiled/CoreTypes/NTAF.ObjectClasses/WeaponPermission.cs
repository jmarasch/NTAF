...
{
	[ObjectClassPlugIn("WeaponPermission", "0.0.0.0")]
	[Serializable]
	public class WeaponPermission : WSPPermission
	{
		...
		public WeaponPermission(string pID, string pName, Species MyBaseRace)
		{
			base.ID = pID;
			base.Name = pName;
		...
		public WeaponPermission(string pID, string pName, Race MyRace)
		{
			base.ID = pID;
			base.Name = pName;
		...
		public WeaponPermission(WeaponPermission permission)
		{
		...
		public WeaponPermission(string pID, string pName, Species MyBaseRace, Race MyRace)
		{
			base.ID = pID;
			base.Name = pName;
			this.SpeciesCanEquip = MyBaseRace;
		...
		{
			bool d = true;
			if ((obj == null ? true : !(obj is WeaponPermission)))
			{
				d = false;
			}
			if (d)
			{
				d = base.ID == ((WeaponPermission)obj).ID;
			}
			if (d)
			{
				d = base.Name == ((WeaponPermission)obj).Name;
			}
			if (d)
			{
				d = this.RaceCanEquip == ((WeaponPermission)obj).RaceCanEquip;
			}
			if (d)
			{
				d = this.SpeciesCanEquip == ((WeaponPermission)obj).SpeciesCanEquip;
			}
			return d;
		}
		...
		{
			return new DataMember[] { new DataMember("Name", base.Name), new DataMember("Type", "Weapon Permission"), new DataMember("Race Can Equip", this.RaceCanEquip), new DataMember("Species Can Equip", (object)this.SpeciesCanEquip) };
		}
		...
		public static bool operator ==(WeaponPermission a, WeaponPermission b)
		{
			bool flag = false;
			try
			{
		...
		{
			element.AddTitleText(string.Concat("Weapon Permission: ", base.Name));
			if (this.RaceCanEquip == null)
			{
		...
		{
			return new WeaponPermission.sortIDHelper_ASC();
		}

		public static IComparer sortIDDsc()
		{
			return new WeaponPermission.sortIDHelper_DSC();
		}

		public static IComparer sortNameDsc()
		{
			return new WeaponPermission.sortNameHelpe_DSC();
		}
